def test_new_stock(new_stock):
    ...
    THEN check the symbol, number of shares and purchase price field are defined correctly
    """
...
def test_new_user(new_user):
    ...
    assert new_user.email == 'ben@email.com'
    assert new_user.password_hashed != 'thisIsATest123'